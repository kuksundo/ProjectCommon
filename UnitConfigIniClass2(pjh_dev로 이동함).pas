...
type
  ...
  public
    ...
    procedure LoadConfig2Form(AForm: TForm; ASettings: TObject=nil); virtual;
    procedure LoadConfigForm2Object(AForm: TForm; ASettings: TObject=nil); virtual;
...
function TINIConfigBase.GetValue(var aValue: TValue): String;
begin
  Result := TIniPersist.GetValue(aValue);
end;
...
procedure TINIConfigBase.SetValue(aData: String; var aValue: TValue;
  aTypeKind: TTypeKind);
begin
  TIniPersist.SetValue(aData, aValue, aTypeKind);
end;
