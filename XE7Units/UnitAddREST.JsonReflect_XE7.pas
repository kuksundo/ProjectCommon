...
{                                                       }
{*******************************************************}
unit UnitAddREST.JsonReflect_XE7;
/// <summary>
...
{$ENDIF MACOS}
  UnitAddREST.Json.Interceptors_XE7;
...
begin
  ...
  try
   ...
   begin
      // TDateTime
      if rttiField.FieldType.QualifiedName = 'System.TDateTime' then // Do not localize
      begin
        case DateFormat of
  ...
  begin
    ...
    try
      ...
      begin
        ...
        ((Field.FieldType.QualifiedName.StartsWith('System.TDate')) or // Do not localize
          (Field.FieldType.QualifiedName = 'System.TTime'))) then // Do not localize
        begin
          case DateFormat of
            jdfISO8601: Result := TJSONInterceptor(TISODateTimeInterceptor.Create(DateTimeIsUTC));
            jdfUnix: Result := TJSONInterceptor(TUnixDateTimeInterceptor.Create(DateTimeIsUTC));
