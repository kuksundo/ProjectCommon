...
type
  ...
  protected
    ...
    function EncodeBytes(Input, Output: PByte; InputLen: Integer; CharSize: SmallInt; LineSeparator: array of Byte;
      var State: TEncodeState): Integer; overload;
    ...
    function DecodeBytes(Input, Output: PByte; InputLen: Integer; CharSize: SmallInt;
      var State: TDecodeState): Integer; overload;
...
uses
  System.RTLConsts, UnitAddSystem.RTLConsts_XE7;
...
begin
  Result := TEncoding.UTF8.GetBytes(DoDecode(TEncoding.UTF8.GetString(@Input[0])));
end;
